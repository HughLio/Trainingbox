...
__C.PIXEL_MEANS = np.array([[[103.52, 116.28, 123.675]]])
...
# single-scale-test
__C.single_scale_test = True

# confidence_threshold used to filter out the final result
